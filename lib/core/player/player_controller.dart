...
class RemuxEngine {
  ...
  void _handleError(String message) {
    ...
    _retryScheduled = true; _retryCount++; unawaited(_retry());
  }
  Future<void> retry() async {
    if (_disposed || _uri == null) return; _retryScheduled = false;
    try { await _openAtPosition(); error.value = null; } on Object catch (retryError) { _handleError(retryError.toString()); }
  }

...
class RemuxTheme extends ThemeExtension<RemuxTheme> {
  const RemuxTheme({
    ...
    this.obsidianRaised = const Color(0xFF121212),
  ...
  final Color obsidian, surface1, surface2, surface3, obsidianRaised, obsidianGlass, obsidianGlassStrong, gold, goldBright, textPrimary, textSecondary, textMuted, success, error, shadowColor;
  final double radiusSmall, radiusMedium, radiusLarge, radiusPill, glassBlur;
  ...
  @override
  RemuxTheme copyWith({Color? obsidian, Color? surface1, Color? surface2, Color? surface3, Color? obsidianRaised, Color? obsidianGlass, Color? obsidianGlassStrong, Color? gold, Color? goldBright, Color? textPrimary, Color? textSecondary, Color? textMuted, Color? success, Color? error, double? radiusSmall, double? radiusMedium, double? radiusLarge, double? radiusPill, double? glassBlur, Color? shadowColor}) => RemuxTheme(obsidian: obsidian ?? this.obsidian, surface1: surface1 ?? this.surface1, surface2: surface2 ?? this.surface2, surface3: surface3 ?? this.surface3, obsidianRaised: obsidianRaised ?? this.obsidianRaised, obsidianGlass: obsidianGlass ?? this.obsidianGlass, obsidianGlassStrong: obsidianGlassStrong ?? this.obsidianGlassStrong, gold: gold ?? this.gold, goldBright: goldBright ?? this.goldBright, textPrimary: textPrimary ?? this.textPrimary, textSecondary: textSecondary ?? this.textSecondary, textMuted: textMuted ?? this.textMuted, success: success ?? this.success, error: error ?? this.error, radiusSmall: radiusSmall ?? this.radiusSmall, radiusMedium: radiusMedium ?? this.radiusMedium, radiusLarge: radiusLarge ?? this.radiusLarge, radiusPill: radiusPill ?? this.radiusPill, glassBlur: glassBlur ?? this.glassBlur, shadowColor: shadowColor ?? this.shadowColor);

  @override
  RemuxTheme lerp(covariant RemuxTheme? other, double t) => other == null ? this : copyWith(obsidian: Color.lerp(obsidian, other.obsidian, t), gold: Color.lerp(gold, other.gold, t));
}

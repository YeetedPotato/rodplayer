...
class RemuxTheme extends ThemeExtension<RemuxTheme> {
  const RemuxTheme({this.obsidian = const Color(0xFF0B0D10), this.obsidianRaised = const Color(0xFF12161C), this.obsidianGlass = const Color(0xCC171C23), this.obsidianGlassStrong = const Color(0xF01D232C), this.gold = const Color(0xFFD6A84F), this.goldBright = const Color(0xFFF0C76A), this.textPrimary = const Color(0xFFF4F0E8), this.textSecondary = const Color(0xFFB5B0A6), this.textMuted = const Color(0xFF77746E), this.success = const Color(0xFF83C98A), this.error = const Color(0xFFE27D72), this.radiusSmall = 8, this.radiusMedium = 14, this.radiusLarge = 22, this.radiusPill = 999, this.shadowColor = const Color(0x66000000)});
  final Color obsidian, obsidianRaised, obsidianGlass, obsidianGlassStrong, gold, goldBright, textPrimary, textSecondary, textMuted, success, error, shadowColor;

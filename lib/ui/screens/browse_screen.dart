...
class _BrowseScreenState extends State<BrowseScreen> {
  ...
  void initState() {
    super.initState();
    widget.client.getItems().then<void>(
      (_) {},
  ...
  Widget _card(String title, int i, {double aspectRatio = 2 / 3}) =>
      FocusableMediaCard(
        title: title,
        subtitle: aspectRatio > 1 ? '${(i + 1) * 12}% watched' : 'Movie',
        imageUrl: _posters[i % _posters.length],
  ...
  Widget _shelf(String title, List<String> items, {double aspectRatio = 2 / 3}) =>
      SmartShelf(
        title: title,
        ...
        itemBuilder: (context, index) => _card(items[index], index, aspectRatio: aspectRatio),
      );
            ...
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                background: Padding(
                  ...
                  child: Row(
                    children: const [
                      RemuxLogo(size: 34, glow: true),
                      SizedBox(width: 10),
                      Text('Remux', style: TextStyle(color: Color(0xFFEBCF52), fontWeight: FontWeight.w700)),
                      Spacer(),
                      Icon(Icons.circle, size: 8, color: Color(0xFFEBCF52)),
                    ],
                  ),
                ),
              ),
              actions: [
                IconButton(onPressed: widget.onLogout, icon: const Icon(Icons.logout), tooltip: 'Log out / switch server'),
              ],
            ),
            SliverToBoxAdapter(
              child: Padding(
                  ...
                  child: ClipRRect(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        const Positioned(left: 24, bottom: 24, child: Text('Featured collection', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w700))),

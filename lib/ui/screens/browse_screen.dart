...
class _BrowseScreenState extends State<BrowseScreen> {
  ...
  Widget _card(String title, int index, {double ratio = 2 / 3}) {
    return GestureDetector(
      ...
      child: FocusableMediaCard(
        ...
        mediaInfo: const MediaIntelligence(
          width: 3840,
          height: 2160,
          video: StreamIntelligence(
            type: 'Video',
            codec: 'hevc',
            videoRange: 'HDR10+',
          ),
          audio: StreamIntelligence(
            type: 'Audio',
            codec: 'truehd',
            channels: 8,
            channelLayout: '7.1',
  ...
  Widget _shelf(String title, List<String> names, {double ratio = 2 / 3}) {
    return SmartShelf(
      title: title,
      ...
      builder: (_) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'A premium Jellyfin media experience with Remux playback intelligence.',
              style: TextStyle(color: Colors.white70),
            ),
            const SizedBox(height: 16),
            const MediaBadges(labels: ['4K', 'HDR10+', 'DV', 'Atmos']),
            ...
            const SizedBox(height: 8),
            const Text(
              'Continue watching, explore seasons, cast and crew, or inspect direct-play compatibility from this detail surface.',
              style: TextStyle(color: Colors.white70),
            ),
            const Spacer(),
          ],
  ...
  Widget build(BuildContext context) {
    final RemuxTheme theme =
        Theme.of(context).extension<RemuxTheme>() ?? const RemuxTheme();
        ...
        drawer: Drawer(
          ...
          child: SafeArea(
            child: ListView(
              ...
              children: [
                const RemuxLogo(size: 44, glow: true),
          ...
          child: CustomScrollView(
            ...
            slivers: [
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: LinearGradient(
                        colors: [theme.green, theme.surface2],
                      ),
                    ...
                    child: const Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 10),
                        MediaBadges(labels: ['4K', 'HDR10+', 'Atmos', 'HEVC']),
                        SizedBox(height: 14),
                        Row(
                          children: [
                            FilledButton.icon(
              ...
              SliverToBoxAdapter(
                child: _shelf(
                  'Continue Watching',
                  ['The Last Voyage', 'Shoreline', 'Night Shift'],
                  ratio: 16 / 9,
                ),
              ),
              SliverToBoxAdapter(
                child: _shelf(
                  'Next Up',
                  ['The Crossing', 'Signal Fire', 'Afterlight'],
                  ratio: 16 / 9,
                ),
              ),
              SliverToBoxAdapter(
                child: _shelf(
                  'Latest Movies',
                  ['The Archive', 'Horizon', 'Northbound'],
                ),
              ),
              SliverToBoxAdapter(
                child: _shelf(
                  'Latest TV Shows',
                  ['Dark Harbor', 'The Bureau', 'Open Water'],
                ),
              ),

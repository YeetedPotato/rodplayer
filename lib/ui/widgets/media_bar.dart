          ...
          builder: (context, bufferingSnapshot) {
            ...
            return StreamBuilder<Duration>(
              ...
              builder: (context, positionSnapshot) {
                ...
                return Semantics(label: 'Media controls', container: true, child: Container(
                  ...
                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    SizedBox(width: 150, child: Slider(min: 0, max: maximum, value: value, onChanged: duration == Duration.zero ? null : (next) => _engine.seek(Duration(milliseconds: next.round())))),
                    _ControlButton(tooltip: isPlaying ? 'Pause' : 'Play', icon: isBuffering ? Icons.hourglass_top_rounded : (isPlaying ? Icons.pause_rounded : Icons.play_arrow_rounded), onPressed: _engine.player.playOrPause),

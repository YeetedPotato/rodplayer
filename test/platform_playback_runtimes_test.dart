...
void main() {
  ...
  test('optional Android runtime probe failure is isolated', () async {
    ...
    expect(runtimes.registry.canExecute(PlaybackBackendIds.mediaKit), isFalse);
    expect(
      runtimes.backendRegistry
          .backendsFor(PlatformFamily.android)
          .singleWhere((backend) => backend.id == PlaybackBackendIds.mediaKit)
          .availability,
